...
lock (ScriptRuntimeEnvironment.consoleLock)
{
    ...
    foreach (var proc in activeTerminalsList)
    {
        ...
        catch { /* Avoid crashing if already closed */ }
    }
...
void RefreshAndGlitchScreen() => ScriptRuntimeEnvironment.RefreshAndGlitchScreen();
...
public class ScriptRuntimeEnvironment
{
    ...
    public static void RenderCustomTerminal()
    {
        lock (consoleLock)
        {
            ...
            Console.ForegroundColor = ConsoleColor.Cyan;
            Console.WriteLine(" ┌──────────────────────────────────────────────────────────┐");
            Console.WriteLine(" │ [核心] CORE EXECUTION MATRIX // REBOOT COMPLETE          │");
            Console.WriteLine(" └──────────────────────────────────────────────────────────┘");
            Console.WriteLine();
